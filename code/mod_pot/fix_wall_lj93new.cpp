...
FixWallLJ93New::FixWallLJ93New(LAMMPS *lmp, int narg, char **arg) :
  FixWall(lmp, narg, arg) {}

/* ---------------------------------------------------------------------- */

void FixWallLJ93New::precompute(int m)
{
  coeff1[m] = 9.0 * sigma[m];
  coeff2[m] = 3.0 * epsilon[m];
  coeff3[m] = sigma[m];		// sigma=c9
  coeff4[m] = epsilon[m];	// epsilon=c3
...
void FixWallLJ93New::wall_particle(int m, int which, double coord)
{
