...
temps=[5, 10, 15, 20, 25, 30, 35, 40, 45, 50]
#sigmoid function of the form f(x)=A/(1+B*exp(-C*x)+D
cg_path='../../protein/cystatin/3GAX/7-aNewCoarsegrained/'
cg_path='../../protein/chickenCystatin/4-coarsegrained/'
sim_path='../../lammps_scripts/1a67_temp/'
...
native = md.load(cg_path+'cg_1a67-filtered.pdb')
trajs = map(lambda fname: md.load(sim_path+'run.{0}.xtc'.format(fname), top=cg_path+'cg_1a67-filtered.pdb'), temps)
